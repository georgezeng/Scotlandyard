package net.georgezeng.gwt.base.jquery.core.bean.animate;

import net.georgezeng.gwt.base.jquery.core.handler.JQAnimateStepHandler;
import net.georgezeng.gwt.base.jquery.core.handler.base.JQCommonHandler;
import net.georgezeng.gwt.base.js.util.JSObject;
