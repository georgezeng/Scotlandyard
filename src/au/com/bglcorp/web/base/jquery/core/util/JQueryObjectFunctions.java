package au.com.bglcorp.web.base.jquery.core.util;

import java.util.Map;

import au.com.bglcorp.web.base.jquery.core.bean.JQueryObject;
import au.com.bglcorp.web.base.jquery.core.bean.animate.AnimateOptions;
import au.com.bglcorp.web.base.jquery.core.handler.JQToggleClassHandler;
...
import au.com.bglcorp.web.base.jquery.core.handler.base.JQIndexHandler;
import au.com.bglcorp.web.base.jquery.core.handler.base.JQValueHandler;
...
public class JQueryObjectFunctions extends JavaScriptObjectFunctions {
      ...
      JQIndexHandler<?> handler) /*-{
		return jqObj[functionName]
				(function(index, currentElement) {
					return handler.@au.com.bglcorp.web.base.jquery.core.handler.base.JQIndexHandler::call(ILcom/google/gwt/dom/client/Element;)(index, currentElement);
				});
  }-*/;
      ...
      String functionName, JQCommonHandler handler) /*-{
		return jqObj[functionName]
				(function(index, currentValue) {
					return handler.@au.com.bglcorp.web.base.jquery.core.handler.base.JQCommonHandler::call(Lcom/google/gwt/dom/client/Element;)(this);
				});
  }-*/;
  ...
  public final native static <T> T treatWithJQValueHandler(JQueryObject jqObj, String functionName,
      JQValueHandler<?, ?> handler) /*-{
		return jqObj[functionName]
				(function(index, currentValue) {
					return handler.@au.com.bglcorp.web.base.jquery.core.handler.base.JQValueHandler::call(Lcom/google/gwt/dom/client/Element;ILjava/lang/Object;)(this, index, currentValue);
				});
  }-*/;
		...
		return jqObj
				.toggleClass(
						function(index, currrentClassName, currrentIsSwitch) {
							return handler.@au.com.bglcorp.web.base.jquery.core.handler.JQToggleClassHandler::call(Lcom/google/gwt/dom/client/Element;ILjava/lang/String;Z)(this, index, currrentClassName, currrentIsSwitch);
						}, isSwitch);
  }-*/;
      ...
      String propName, JQValueHandler<?, ?> handler) /*-{
		return jqObj[functionName]
				(
						propName,
						function(index, currentValue) {
							return handler.@au.com.bglcorp.web.base.jquery.core.handler.base.JQValueHandler::call(Lcom/google/gwt/dom/client/Element;ILjava/lang/Object;)(index, currentValue);
						});
  }-*/;
  ...
  public final native static JQueryObject treatEvent(JQueryObject jqObj, String functionName,
      ...
      boolean exchangeArgumentPositionForSelectorAndEventTypes) /*-{
		...
		if (handler) {
			argumentArr
					.push(function(event) {
						handler.@au.com.bglcorp.web.base.jquery.core.handler.base.JQEventHandler::call(Lcom/google/gwt/dom/client/Element;Lau/com/bglcorp/web/base/jquery/core/bean/event/JQEvent;)(this, event);
					});
		}
		return jqObj[functionName].apply(jqObj, argumentArr);
  }-*/;
